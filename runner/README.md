...
- OxideBot 1.0 官方 `oxidebot-adapter-telegram`；
- `china_unicom_oxidebot` 1.0 中国联通余量查询、凭据续期和通知插件；
...
不要在这里硬编码 Telegram Token、Bot ID 或联通登录 JSON。Telegram 配置通过模块 WebUI/App
